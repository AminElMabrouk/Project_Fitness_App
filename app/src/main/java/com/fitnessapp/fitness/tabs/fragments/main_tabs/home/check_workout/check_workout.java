package com.fitnessapp.fitness.tabs.fragments.main_tabs.home.check_workout;
...
public class check_workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            Toast.makeText(check_workout.this, "Date sélectionnée : " + selectedDate, Toast.LENGTH_SHORT).show();
